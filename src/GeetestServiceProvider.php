...
class GeetestServiceProvider extends ServiceProvider
{
    ...
    public function boot()
    {
        ...
        $this->publishes([
            __DIR__ . '/views' => base_path('resources/views/vendor/laravel-geetest'),
            __DIR__ . '/config.php' => config_path('geetest.php'),
        ], 'laravel-geetest');

        Route::get('geetest', 'Bhekor\LaravelGeetest\GeetestController@getGeetest');
...
{
$this->app->singleton('laravelgeetest', function () {
